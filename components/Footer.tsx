        ...
        <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
          ...
          <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-3/5 sm:grid-cols-3">
            <div className="space-y-3">
              ...
              <Link href={"tel:8376033570"}>8376033570</Link>
            </div>
            <div className="space-y-3">
              <h3 className="tracking-wide dark:text-gray-50 font-medium mb-3">
                Email
            ...
            <div className="space-y-3">
              <div className="dark:text-gray-50 font-medium">Follow me on</div>
              <div className="flex justify-start space-x-3">
                <Link
                  rel="noopener noreferrer"
                  href="https://www.instagram.com/sjeetaggarwal/"
                  title="Instagram"
                ...
                <Link
                  rel="noopener noreferrer"
                  href="https://www.facebook.com/sanjay.aggarwal.7355/"
                  title="Facebook"
                  className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 dark:bg-violet-400 dark:text-gray-900"
                  target={"_blank"}
                >
